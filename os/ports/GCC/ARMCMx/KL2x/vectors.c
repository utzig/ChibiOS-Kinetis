...
/**
 * @file    GCC/ARMCMx/KL2x/vectors.c
 * @brief   Interrupt vectors for the Kinetis KL2x family.
 *
 * @defgroup ARMCMx_KL2x_VECTORS Kinetis KL2x Interrupt Vectors
 * @ingroup ARMCMx_SPECIFIC
 * @details Interrupt vectors for the Kinetis KL2x family.
 * @{
 */
...
/**
 * @brief   Kinetis KL2x vectors table.
 */
#if !defined(__DOXYGEN__)
