...
const PALConfig pal_default_config =
{
  .ports = {
    ...
    },
    {
      .port = IOPORT4,  // PORTD
      .pads = {
        /* PTD0*/ PAL_MODE_INPUT_ANALOG,    /* PTD1*/ PAL_MODE_INPUT_ANALOG,    /* PTD2*/ PAL_MODE_INPUT_ANALOG,
    ...
    },
    {
      ...
      .pads = {
        ...
        /*PTE24*/ PAL_MODE_INPUT_ANALOG,    /*PTE25*/ PAL_MODE_INPUT_ANALOG,    /*PTE26*/ PAL_MODE_UNCONNECTED,
